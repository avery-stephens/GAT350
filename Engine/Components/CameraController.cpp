...
namespace boogleborg
{
	...
	void CameraController::Update()
	{
		...
		if (g_inputSystem.GetKeyState(key_pgup) == InputSystem::KeyState::Held)	direction.z += 1;
		if (g_inputSystem.GetKeyState(key_pgdown) == InputSystem::KeyState::Held) direction.z -= 1;
